...
/**
* A concrete subclass of {@link ol.render.VectorContext} that implements direct rendering of features and geometries to an HTML5 Canvas context.
* Instances of this class are created internally by the library and provided to application code as <code>vectorContext</code> member
* of the {@link ol.render.Event} object associated with <code>postcompose</code>, <code>precompose</code> and <code>render</code> events emitted by layers and maps.
* 
* @author gkresic
* 
* @see https://openlayers.org/en/latest/apidoc/ol.render.canvas.Immediate.html
*/
