...
public interface TileGridOptions extends Options {
     ...
     */
    @JsProperty
    TileGridOptions setExtent(Extent extent);
     ...
     */
    @JsProperty
    TileGridOptions setMaxZoom(int maxZoom);
     ...
     */
    @JsProperty
    TileGridOptions setMinZoom(int minZoom);
     ...
     */
    @JsProperty
    TileGridOptions setOrigin(Coordinate coordinate);
     ...
     */
    @JsProperty
    TileGridOptions setOrigins(Coordinate[] origins);
     ...
     */
    @JsProperty
    TileGridOptions setResolutions(double[] resolutions);
     ...
     */
    @JsProperty
    TileGridOptions setTileSize(Size tileSize);
     ...
     */
    @JsProperty
    TileGridOptions setTileSizes(Size[] tileSizes);
